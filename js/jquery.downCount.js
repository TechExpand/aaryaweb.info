!function(e) {
    e.fn.downCount = function(t, n) {
        ...
        var i = setInterval(function() {
            ...
            var t = 360e5,
                a = Math.floor(e / 8064e5),
                d = Math.floor(e % 8064e5 / t),
            ...
            o.find(".days").text(a), o.find(".hours").text(d), o.find(".minutes").text(s), o.find(".seconds").text(u), o.find(".").text(l), o.find(".hours_ref").text(h), o.find(".minutes_ref").text(c), o.find(".seconds_ref").text(g)
        }, 1e3)
    }
}(jQuery);